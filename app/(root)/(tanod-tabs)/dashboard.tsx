...
type Assignment = { _id: string; reportId?: string; reportStatus?: string; status?: string; locationName?: string; address?: string; assignedAt?: string; _creationTime?: number };
...
const shared = StyleSheet.create({
  metric: { flex: 1, borderWidth: 1, borderRadius: 18, padding: 14, gap: 5 }, metricValue: { fontSize: 24, fontWeight: "900", letterSpacing: -0.8 }, metricLabel: { fontSize: 11, fontWeight: "700" },
  action: { flex: 1, borderWidth: 1, borderRadius: 20, padding: 15 }, actionIcon: { width: 40, height: 40, borderRadius: 13, alignItems: "center", justifyContent: "center", marginBottom: 16 }, actionTitle: { fontSize: 14, fontWeight: "800" }, actionCopy: { fontSize: 11, marginTop: 4 },
});
const createStyles = (C: ThemeColors) => StyleSheet.create({
  ...
  hero: { backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 26, padding: 20 }, heroTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }, dutyBadge: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 10, paddingVertical: 6, backgroundColor: C.safeGlow, borderRadius: 999, borderWidth: 1, borderColor: C.safe + "35" }, liveDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: C.safe }, dutyText: { color: C.safe, fontSize: 9, fontWeight: "900", letterSpacing: 1 }, avatar: { width: 42, height: 42, borderRadius: 14, backgroundColor: C.surfaceRaised, borderWidth: 1, borderColor: C.border }, kicker: { color: C.accent, fontSize: 9, fontWeight: "900", letterSpacing: 1.4 }, heroTitle: { color: C.text, fontSize: 25, fontWeight: "900", letterSpacing: -0.8, marginTop: 6 }, heroCopy: { color: C.textSub, fontSize: 13, lineHeight: 19, marginTop: 7 },
  progressRow: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 20 }, progressTrack: { flex: 1, height: 7, borderRadius: 5, backgroundColor: C.surfaceRaised, overflow: "hidden" }, progressFill: { height: "100%", borderRadius: 5, backgroundColor: C.safe }, progressText: { color: C.textSub, fontSize: 10, fontWeight: "800" }, metrics: { flexDirection: "row", gap: 9 }, actions: { flexDirection: "row", gap: 10 }, sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 4 }, eyebrow: { color: C.accent, fontSize: 8, fontWeight: "900", letterSpacing: 1.4 }, sectionTitle: { color: C.text, fontSize: 19, fontWeight: "900", marginTop: 3 }, viewAll: { flexDirection: "row", alignItems: "center", gap: 4, padding: 8 }, viewAllText: { color: C.accent, fontSize: 12, fontWeight: "800" },
  queue: { gap: 10 }, queueCard: { minHeight: 82, flexDirection: "row", alignItems: "center", gap: 12, padding: 11, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 19 }, pinBox: { width: 58, height: 58, borderRadius: 17, alignItems: "center", justifyContent: "center" }, pin: { width: 54, height: 54 }, queueBody: { flex: 1, gap: 3 }, queueLevel: { fontSize: 8, fontWeight: "900", letterSpacing: 1.1 }, location: { color: C.text, fontSize: 13, fontWeight: "800" }, time: { color: C.textSub, fontSize: 10 }, empty: { alignItems: "center", padding: 26, gap: 7, backgroundColor: C.surface, borderRadius: 20, borderWidth: 1, borderColor: C.border }, emptyTitle: { color: C.text, fontSize: 15, fontWeight: "900" }, emptyText: { color: C.textSub, fontSize: 12, textAlign: "center" },
});
