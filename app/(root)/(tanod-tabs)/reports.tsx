...
const chip = StyleSheet.create({ base: { flexDirection: "row", alignItems: "center", gap: 6, borderWidth: 1, borderRadius: 999, paddingVertical: 8, paddingHorizontal: 11 }, label: { fontSize: 10, fontWeight: "800" }, count: { minWidth: 19, height: 19, borderRadius: 10, alignItems: "center", justifyContent: "center", paddingHorizontal: 4 }, countText: { fontSize: 9, fontWeight: "900" } });
const card = StyleSheet.create({ root: { borderWidth: 1, borderRadius: 22, overflow: "hidden" }, visual: { height: 112, position: "relative", overflow: "hidden" }, photo: { ...StyleSheet.absoluteFillObject }, scrim: { ...StyleSheet.absoluteFillObject }, pin: { position: "absolute", width: 78, height: 78, left: 10, bottom: -5 }, status: { position: "absolute", right: 12, top: 12, flexDirection: "row", alignItems: "center", gap: 5, borderRadius: 999, paddingVertical: 6, paddingHorizontal: 9 }, statusText: { color: "#FFF", fontSize: 8, fontWeight: "900", letterSpacing: 1 }, body: { padding: 14, gap: 9 }, locationRow: { flexDirection: "row", alignItems: "center", gap: 6 }, location: { flex: 1, fontSize: 14, fontWeight: "900" }, copy: { fontSize: 11, lineHeight: 17 }, footer: { borderTopWidth: 1, paddingTop: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, date: { fontSize: 10 }, open: { flexDirection: "row", alignItems: "center", gap: 2 }, openText: { fontSize: 9, fontWeight: "900", letterSpacing: 1 } });
const createStyles = (C: ThemeColors) => StyleSheet.create({ root: { flex: 1, backgroundColor: C.bg }, loading: { flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: C.bg, gap: 10 }, loadingPin: { width: 64, height: 64 }, loadingText: { color: C.textSub, fontSize: 12, fontWeight: "700" }, list: { padding: 16, paddingBottom: 118, gap: 12 }, hero: { flexDirection: "row", alignItems: "center", gap: 13, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 23, padding: 17, marginBottom: 14 }, heroIcon: { width: 48, height: 48, borderRadius: 16, alignItems: "center", justifyContent: "center", backgroundColor: C.accentGlow }, heroBody: { flex: 1 }, eyebrow: { color: C.accent, fontSize: 8, fontWeight: "900", letterSpacing: 1.2 }, title: { color: C.text, fontSize: 21, fontWeight: "900", letterSpacing: -0.5, marginTop: 3 }, subtitle: { color: C.textSub, fontSize: 11, marginTop: 3 }, searchBox: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 14, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 16, marginBottom: 13 }, searchInput: { flex: 1, color: C.text, fontSize: 13, paddingVertical: 10 }, filterHeading: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 9 }, filterHeadingText: { color: C.textSub, fontSize: 8, fontWeight: "900", letterSpacing: 1.2 }, filters: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginBottom: 18 }, resultsHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 2 }, resultsTitle: { color: C.text, fontSize: 15, fontWeight: "900" }, resultsMeta: { color: C.safe, fontSize: 9, fontWeight: "800" }, empty: { alignItems: "center", paddingVertical: 45 }, emptyPin: { width: 88, height: 88 }, emptyTitle: { color: C.text, fontSize: 16, fontWeight: "900", marginTop: 5 }, emptyText: { color: C.textSub, fontSize: 12, marginTop: 5 } });
